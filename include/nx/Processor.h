...
namespace nx {
   ...
   struct NxRec {
      ...
      NxRec() : used(false), isbaseline(false), fChannels(nullptr), fADCs(nullptr), fHITt(nullptr)
      {
   ...
   class Processor : public base::SysCoreProc {
      ...
      public:
         ...
         Processor(unsigned rocid, unsigned nxmask = 0x5, base::OpticSplitter* spl = nullptr);
         virtual ~Processor();
