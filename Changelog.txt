2.02.2026
1. Support scaler data in CTS subevent. If at the end of the data "LUPO" (0x4c55504f) or
   "lupo" (0x6c75706f) word is found, then such data decoded as scaler. Add valid flag
   to scaler event.
